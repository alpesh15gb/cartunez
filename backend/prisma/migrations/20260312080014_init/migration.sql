...
-- CreateIndex
CREATE UNIQUE INDEX "VehicleCompatibility_productId_modelId_startYear_key" ON "VehicleCompatibility"("productId", "modelId", "startYear");
...
-- AddForeignKey
ALTER TABLE "VehicleCompatibility" ADD CONSTRAINT "VehicleCompatibility_modelId_fkey" FOREIGN KEY ("modelId") REFERENCES "VehicleModel"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
